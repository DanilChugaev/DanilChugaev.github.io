...
*/
var require_valid_template_root = /* @__PURE__ */ require_runtime.__commonJSMin(((exports, module) => {
	...
	module.exports = {
		...
		create(context) {
			...
			return { Program(program) {
				...
				if (hasSrc && rootElements.length > 0) for (const element of rootElements) context.report({
					node: element,
					loc: element.loc,
					messageId: "emptySrc"
				});
