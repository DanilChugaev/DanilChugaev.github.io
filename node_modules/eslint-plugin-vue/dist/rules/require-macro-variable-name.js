...
var require_require_macro_variable_name = /* @__PURE__ */ require_runtime.__commonJSMin(((exports, module) => {
	...
	module.exports = {
		...
		create(context) {
			...
			const relevantMacros = new Set([...Object.keys(DEFAULT_OPTIONS), "withDefaults"]);
			return utils.defineScriptSetupVisitor(context, { VariableDeclarator(node) {
				if (node.init && node.init.type === "CallExpression" && node.init.callee.type === "Identifier" && relevantMacros.has(node.init.callee.name)) {
