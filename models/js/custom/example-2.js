...
let Game = {
    ...
    Automate = {
        calculateValue(nowState, inputState) {
            ...
            if((nowState === 3 || nowState === 1) && (inputState === 10 || inputState === 20 || inputState === 50 || inputState === 60)) return 4;
    ...
    startBtn.addEventListener('click', () => {
        ...
        if(countIterations.innerText !== '') {
            ...
            countIterations = Number(countIterations)
                ...
                while(iteration < countIterations) {
            ...
            const series1 = Game.getCounter()[1],
                ...
                sum = series1 + series2 + series3 + series4;
